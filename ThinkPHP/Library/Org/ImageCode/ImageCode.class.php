<?php
	...
	class ImageCode{
		...
		private $distrubcode;
		private $session;
		function __construct($width = 120,$height = 50,$counts = 4,$distrubcode="1235467890"){
			$this->width=$width;
			$this->height=$height;
			$this->counts=$counts;
		...
		private function setdistrubecode($im){
			...
			for($i=0;$i<$cou;$i++){
				...
				$jiaodu=rand(0,360);
				$fontsize=rand(8,15);
				$fonturl=LIB_PATH."Org/ImageCode/TektonPro-BoldCond.otf";
		...
		private function set_code($im){
				...
				$fontsize=rand(30,35);
				$fonturl=LIB_PATH."Org/ImageCode/AdobeGothicStd-Bold.otf";
